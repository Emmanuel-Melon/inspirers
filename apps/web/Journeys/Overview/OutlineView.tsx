...
import { UserProfileCard } from "../../pages/user/components/UserProfileCard";
    ...
    <Flex gap={8} height="100%">
          ...
          <Flex direction="column" width="100%" gap={8}>
            ...
            <Stack>
              ...
              <Text>
                ...
                future. I've used LinkedIn for several years but barely got
                noticed because such platforms are biased and only favor the
                experienced.
              </Text>
              <Text>
                In the first half, you will learn how to build a full search
                experience using Algolia's search API and by utilizing Algolia's
                InstantSearch library. In the second half, you will learn how to
                extend Algolia's widgets by building a custom search experience.
              </Text>
              <Text>
      ...
      <Flex flex={1} direction="column" gap={4}>
        ...
        <Stack alignItems="flex-start" gap={2}>
          <Tag borderRadius="1rem" gap={2}>
            <FiBarChart /> Beginner
          </Tag>
          <Tag borderRadius="1rem" gap={2}>
            <FiBarChart /> Invite Friends
          </Tag>
          <Tag borderRadius="1rem" gap={2}>
            <FiBarChart /> Share
          </Tag>
          <Button size="sm" icon={<FiTruck />} onClick={() => {}}>
            Begin Journey
          </Button>
        </Stack>
      </Flex>
