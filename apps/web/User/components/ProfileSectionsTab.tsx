        ...
        <TabPanels>
          <TabPanel p="none">
            <VStack gap="8" justifyContent="center" alignItems="center">
              <Image src="https://res.cloudinary.com/dwacr3zpp/image/upload/v1658951639/inspirers/images/9094bc98-b99d-4474-9803-13eaaaccc383.png" />
              <Text>Oops! no journeys yet.</Text>
              <Button
                bg="brand.primary"
                color="brand.white"
                size="md"
          ...
          <TabPanel p="none">
            <VStack gap="8" justifyContent="center" alignItems="center">
              <Image src="https://res.cloudinary.com/dwacr3zpp/image/upload/v1658951299/inspirers/images/729a0ff0-9727-4b73-b2b5-26d23f5e442d.png" />
              <Text>Oops! no activity yet.</Text>
              <Button
                bg="brand.primary"
                color="brand.white"
                size="md"
          ...
          <TabPanel p="none">
            <VStack gap="8" justifyContent="center" alignItems="center">
              <Image src="https://res.cloudinary.com/dwacr3zpp/image/upload/v1658951330/inspirers/images/8a6a6be1-df6c-482e-8f05-2e089ab083f5.png" />
              <Text>Oops! no mentees yet.</Text>
              <Button
                bg="brand.primary"
                color="brand.white"
                size="md"
          ...
          <TabPanel p="none">
            <VStack gap="8" justifyContent="center" alignItems="center">
              <Image src="https://res.cloudinary.com/dwacr3zpp/image/upload/v1658951972/inspirers/images/3ef610d9-84ff-4ab3-b809-4fda743dceee.png" />
              <Text>Oops! no tasks yet.</Text>
              <Button
                bg="brand.primary"
                color="brand.white"
                size="md"
          ...
          <TabPanel p="none">
            <VStack gap="8" justifyContent="center" alignItems="center">
              <Image src="https://res.cloudinary.com/dwacr3zpp/image/upload/v1658952252/inspirers/images/3072ccca-26d9-4b94-9b1b-979661a6da7f.png" />
              <Text>Oops! no backpacks yet.</Text>
              <Button
                bg="brand.primary"
                color="brand.white"
                size="md"
