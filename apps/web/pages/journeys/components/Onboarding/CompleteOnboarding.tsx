...
export const FourthStepGuide = () => {
    ...
    return (
        <Flex direction="column" gap={4}>
            <Heading color="brand.primary">{context.currentStep.id} - {context.currentStep.title} (Optional)</Heading>
            <Flex
                alignItems="center"
                bg="brand.white"
            ...
            >
                ...
                <Text color="brand.primary">You are all set now, let us begin navigating the journey.</Text>
            </Flex>
...
export const FourthStep = () => {
    ...
    return (
        ...
        >
            ...
            <Text fontWeight="700">Accounts to follow</Text>
